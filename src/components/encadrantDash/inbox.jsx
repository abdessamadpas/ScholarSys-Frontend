...
const Inbox = (props) => {
  ...
  const startnewFetch = async () => {
    let response = await fetch(`http://localhost:5000/group/${props.group._id}`, {
      method: 'GET',
      headers: {
    ...
    <div>
      <div className="containerr">
        ...
        <div className="inbox-container">
          <div className="inbox">
            ...
            </div>
            {
              ...
              group.tasks ? group.tasks.map((task) => (
                <div className="msg selected-bg anim-y" key={task._id}>
                  <input type="checkbox" name="msg" id="mail1" className="mail-choice" checked />
                  <label for="mail1"></label>
                  <div className="msg-content">
                    <div className="msg-title">{task.task} :
                    </div>
                    <div className="msg-date">{getDate(task)}</div>
                  </div>
          ...
          <PopupTask wewe={button} setWewe={setButton} group={props.group} startnewFetch={startnewFetch}></PopupTask>
        ...
        <div className="mail-detail">
          <div className="mail-detail-header">
            <div className="mail-detail-profile">
              ...
              <div className="mail-detail-name"> Abdessamad Aalouwan</div>
            </div>
